...
2.1: /login
    Service used: 1.4, to generate a default user.
    Authentication not completed as it was not required. 
    Redirected and stored user information in state for use in welcome Page.
